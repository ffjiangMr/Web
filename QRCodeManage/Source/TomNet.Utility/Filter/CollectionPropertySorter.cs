...
using TomNet.Utility.Properties;


namespace TomNet.Utility.Filter
{
    /// <summary>
    /// 集合类型字符串排序操作类
    /// </summary>
    ...
    public static class CollectionPropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new TomNetException(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, propertyName));
                }
